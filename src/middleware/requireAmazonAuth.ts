...
/**
 * Middleware that requires Amazon OAuth tokens but NOT profileId
 * Use this for endpoints that need to fetch profiles or select a profile
 *
 * Prerequisites:
 ...
 *
 * Does NOT require profileId to be set
 */
export const requireAmazonTokens = async (
  req: AuthRequest,
  res: Response,
  next: NextFunction
): Promise<void> => {
