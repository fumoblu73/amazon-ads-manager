  ...
  return (
    <div className="h-full p-8 overflow-hidden flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-2 gap-6 min-h-0">
        {/* Function 1 */}
        <div className="bg-black border-2 border-orange-500 rounded-xl p-5 overflow-auto">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Bid Increase</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Freq. (gg)</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Max Impr.</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Max Click</label>
        ...
        <div className="bg-black border-2 border-orange-500 rounded-xl p-5 overflow-auto">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Timeframe (sett.)</label>
        ...
        <div className="bg-black border-2 border-orange-500 rounded-xl p-5 overflow-auto">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Freq.</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">TF A</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">TF B</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">TF C</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Click Pause</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Click 65gg</label>
        ...
        <div className="bg-black border-2 border-orange-500 rounded-xl p-5 overflow-auto">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Click Neg.</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Spend Neg.</label>
        ...
        {/* Function 5 */}
        <div className="bg-black border-2 border-orange-500 rounded-xl p-5 overflow-auto col-span-2">
          <div className="flex items-center justify-between mb-3">
            <div>
          ...
          <div className="grid grid-cols-6 gap-2">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Min Ordini</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Bid Broad</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Bid Exact</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Bid Phrase</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Bid Expand</label>
